...
* add leds control animations (the WLED driver already exposes effects, presets and a realtime per-pixel channel: see `server/hw_controller/leds/leds_types/wled.py`)
